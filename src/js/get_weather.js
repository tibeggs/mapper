...
const base_url = 'purple-moon-a601.cwmtb.workers.dev/https://api.weather.gov/points/';
...
async function get_weather_periods(target_url) {
  let url = "purple-moon-a601.cwmtb.workers.dev/"+target_url
